...
CONST_MODE_FAN_UNKNOWN = 'unknown'
...
CONST_FAN_CMD_MAP = {CONST_MODE_FAN_AUTO:0, CONST_MODE_FAN_UNKNOWN: 1, CONST_MODE_FAN_LOW:2, CONST_MODE_FAN_MIDDLE:3, CONST_MODE_FAN_HIGH:4, CONST_MODE_FAN_OFF:5}
...
class Thermostat(ClimateEntity):
    ...
    def __init__(self, name, ac_name, host, port, acdata):
        ...
        self._fan_list = [CONST_MODE_FAN_OFF, CONST_MODE_FAN_AUTO, CONST_MODE_FAN_UNKNOWN, CONST_MODE_FAN_LOW, CONST_MODE_FAN_MIDDLE, CONST_MODE_FAN_HIGH]
